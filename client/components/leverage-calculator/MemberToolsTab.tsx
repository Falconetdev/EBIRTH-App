    ...
    <div className="animate-slide-up flex flex-col items-center text-center space-y-8 py-4 relative">
      ...
      <div className="w-full bg-gradient-to-b from-white/10 to-transparent p-[1px] rounded-2xl relative z-10 overflow-hidden group">
         ...
         <div className="bg-[#0c081f] rounded-2xl p-6 backdrop-blur-md">
            ...
            <li className="flex items-start gap-4">
                <div className="mt-1 w-10 h-10 rounded-xl bg-green-500/10 flex items-center justify-center text-green-400 border border-green-500/20 shadow-[0_0_15px_rgba(34,197,94,0.1)]">
                <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />
                </svg>
                </div>
                <div>
                <div className="text-white font-bold text-base mb-1">📝 Personal Trading Plan</div>
                <div className="text-gray-400 text-xs leading-relaxed">Customized risk management and growth plan tailored to your capital.</div>
                </div>
            </li>
            </ul>
         </div>
